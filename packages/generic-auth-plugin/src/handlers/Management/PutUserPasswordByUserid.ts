import { badRequest, FlinkContext, Handler, notFound } from "@flink-app/flink";
...
const PutManagementUserPasswordByUserid: Handler<
  FlinkContext,
  PutManagementUserPasswordByUseridReq,
  PutManagementUserPasswordByUseridRes
> = async ({ ctx, req, origin }) => {
  ...
  const createPasswordHashAndSaltMethod =
